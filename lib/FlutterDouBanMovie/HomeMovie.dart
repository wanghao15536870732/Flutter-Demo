...
class _HomeState extends State<MovieHome> with SingleTickerProviderStateMixin{
  ...
  requestMovieTop() async {
    ...
    Map<String,dynamic> newData = json.decode(newResponse.body);
    setState(() {
      subjects = data['subjects'];
      topSubjects = result['subjects'];
      newSubjects = newData['subjects'];
    });
  }
              ...
              BackdropFilter(
                ...
                child: new Column(
                  ...
                  children: <Widget>[
                    ...
                    new GestureDetector(
                      child: getTop250(newSubjects[0],newSubjects[1],newSubjects[2],
                        "新片榜","热门电影",),
                      onTap: (){
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => new DouBanListView(subjectList: newSubjects)));
                      },
                    ),
                  ],
                ),
