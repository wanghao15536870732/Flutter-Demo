...
import 'package:demoflutter/FlutterCalculator/operator.dart';
...
class ResultDisplay extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return Text(
      ...
      style: TextStyle(
        fontSize: 70.0,fontWeight: FontWeight.w500,color: Colors.black,
      ),
    );
  }
}
...
class HistoryBlock extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: EdgeInsets.only(top: 10.0,bottom: 16.0,right: 16.0),
      child: Container(
